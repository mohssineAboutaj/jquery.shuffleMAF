...
(function ( $ ) {
  $.fn.shuffleMAF = function(e) {
    ...
    this.each(function(){
      ...
      // define shortHand if...else variables
      var myEffect,
          time,
          classActive;

      // the main effect if not defined the default effect is fadeIn/fadeOut
  //    myEffect = void 0 === $(this).attr('data-shuffleMAF-effect') ? "fade" : $(this).attr('data-shuffleMAF-effect');
  ...
  //    time = void 0 === $(this).attr('data-shuffleMAF-time') ? 700 : $(this).attr('data-shuffleMAF-timz');
